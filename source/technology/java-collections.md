...
* **2. Compare-and-Swap (CAS)**
  ...
  * This technique is caled [*Optimistic Concurrency Control*](http://localhost:4000/technology/transaction.html#optimistic) and is widely used in databases and HTTP protocol.
